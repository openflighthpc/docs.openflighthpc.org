const templateData = [
  ...
  {
    "id": "container-cruncher-medium",
    "title": "Container Cruncher (Medium)",
    "tagline": "A medium single-user Kubernetes environment, suitable for running workflows and microservices.",
    "num_users": 1,
    "lifetime": 6,
    "storage": 500,
    "cost": 20,
  ...
  {
    "id": "container-cruncher-large",
    "title": "Container Cruncher (Large)",
    "tagline": "A large single-user Kubernetes environment, suitable for running multiple workflows and many microservices.",
    "num_users": 1,
    "lifetime": 12,
    "storage": 1024,
    "cost": 35,
  ...
  {
    "id": "jupyterlab-jumpstart",
    "title": "JupyterLab Jumpstart",
    "tagline": "A standalone, single-user JupyterLab environment, suitable for interactive development of various scientific workflows",
    "num_users": 1,
    "lifetime": 6,
    "storage": 100,
    "cost": 3,
